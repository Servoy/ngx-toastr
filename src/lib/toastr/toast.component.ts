...
@Component({
  ...
  template: `
  <button *ngIf="options.closeButton && options.closeHtml" (click)="remove()" type="button" 
    class="toast-close-button" aria-label="Close" aria-hidden="true" [innerHTML]="options.closeHtml">
  </button>
  <button *ngIf="options.closeButton && !options.closeHtml" (click)="remove()" type="button" class="toast-close-button" aria-label="Close">
